...
callbacks_list = [save_best, early_stop, TensorBoard(log_dir='/tmp/selfdriving')]

model.fit(train_X, train_Y, batch_size=64, epochs=6, validation_data=(val_X, val_Y), callbacks=callbacks_list)
